...
#define MKL_UNIFORM_RND_METHOD VSL_RNG_METHOD_UNIFORM_STD
#define MKL_GAUSSIAN_RND_METHOD VSL_RNG_METHOD_GAUSSIAN_BOXMULLER
...
// #endif
	...
	void TransposeRightMult(const Matrix &b, MTYPE scaleAB, Matrix &target) const;
	...
	void transposeReVoid(bool hard, Matrix &meTrans) const;
    ...
    void randomizeUniform(VSLStreamStatePtr stream, MTYPE a=0,MTYPE b=1);
